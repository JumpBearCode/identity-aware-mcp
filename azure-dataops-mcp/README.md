...
```bash
# 1. Provision Entra apps, SPs, AD groups
...
# 4. Wire VS Code (.vscode/mcp.json):
...
* **`provisioning/python/`** — `msgraph-sdk` + `azure-mgmt-authorization`. Recommended for first-time setup; easier to debug, prints all IDs/secrets.
